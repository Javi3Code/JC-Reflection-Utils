...
public interface JCReflectionUtils
{
      ...
      default Object[] getValuesIntoArray(final List<?> list,final String[] methodName,final int e) throws NoSuchMethodException,
      ...
      private void loadArrayOfData(final String[] methodName,final Class<?> instanceClass,final Object instance,Object[] methods)
